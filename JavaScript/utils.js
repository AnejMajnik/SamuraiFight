...
function determineWinner({player, enemy, timerId}){
  ...
  if(player.health==enemy.health){
    document.querySelector('#rezultat').innerHTML="Tie";
  }else if(player.health>enemy.health){
    document.querySelector('#rezultat').innerHTML="Player 1 Wins";
  }else if(player.health<enemy.health){
    document.querySelector('#rezultat').innerHTML="Player 2 Wins";
  }
}
